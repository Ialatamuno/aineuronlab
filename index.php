        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="space-y-6 text-gray-700 leading-relaxed">
                    <p>
                        En <strong>AI Neuron Lab</strong>, transformamos la manera en que las empresas operan mediante
                        soluciones de inteligencia artificial de vanguardia. Desde Paraguay, llevamos tecnología de
                        clase mundial a tu negocio.
                    </p>
                    <p>
...
<section class="py-24 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="space-y-6 text-gray-700 leading-relaxed text-left max-w-2xl mx-auto">
                <p>
                ...
                <p>
                    Hemos desarrollado soluciones que combinan investigación académica de vanguardia con aplicaciones
